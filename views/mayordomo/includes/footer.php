<?php
/**
 * ARCHIVO: views/mayordomo/includes/footer.php
 * PROPÓSITO: Cierra las etiquetas abiertas por sidebar.php
 *            Cierra etiquetas y modal de sesión (notificaciones en sidebar).
 * Se incluye al FINAL de cada vista del mayordomo:
...
<script>
  /* Notificaciones: overlay y JS viven en includes/sidebar.php (evita duplicar IDs y
     sobrescribir toggleNotifPanel sin enlaces "Ver →"). */
