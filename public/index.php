<!--
  ...
  Es la primera página que ve cualquier visitante del sistema.
  No requiere autenticación.

  Secciones:
    - Header: logo AgroFinca + menú de navegación
    - Hero Slider: carrusel con 3 imágenes
    - Propósito: 3 tarjetas con Misión, Visión y Objetivos
    - Footer: descripción, enlaces rápidos, legal y contacto
    - Chatbot Flotante

  Estilos: public/index.css
  ============================================================
-->
<!DOCTYPE html>
<html lang="es">
...
<body>
  ...
  <header class="header">
    <div class="container nav">
      ...
      <nav class="menu">
        ...
        <a href="#">Servicios</a>
        <a href="../views/usuarios/login.php" class="nav-btn">Ingresar</a>
      </nav>
    </div>
  </header>
  ...
  <section id="heroCarousel" class="carousel slide hero-carousel" data-bs-ride="carousel" data-bs-interval="5000" data-bs-pause="false">
    ...
    <div class="carousel-inner">
      <!-- Slide 1 -->
      <div class="carousel-item active" style="background-image: url('../img/hero_bg.png');">
        ...
        <div class="container hero-content text-start">
          ...
          <a href="../views/usuarios/login.php" class="btn-primary animate-up delay-2">
            Empezar Ahora
      ...
      <!-- Slide 2 -->
      <div class="carousel-item" style="background-image: url('../img/slider2_bg.png');">
        <div class="carousel-overlay"></div>
        <div class="container hero-content text-start">
      ...
      <!-- Slide 3 -->
      <div class="carousel-item" style="background-image: url('../img/slider3_bg.png');">
        <div class="carousel-overlay"></div>
        <div class="container hero-content text-start">
      ...
      <div class="cards">
        ...
        <div class="card">
          <div class="img-wrapper">
            <img src="../img/mision.png" alt="Misión de AgroFinca" />
          </div>
          <div class="card-body">
            <h3>Misión</h3>
            <p>
        ...
        <div class="card">
          <div class="img-wrapper">
            <img src="../img/vision.png" alt="Visión de AgroFinca" />
          </div>
          <div class="card-body">
            <h3>Visión</h3>
            <p>
        ...
        <div class="card">
          <div class="img-wrapper">
            <img src="../img/objetivo.png" alt="Objetivos de AgroFinca" />
          </div>
          <div class="card-body">
            <h3>Objetivos</h3>
            <p>
  ...
  <footer class="footer">
    <div class="container footer-grid">
      ...
      <div class="footer-col">
        ...
        <a href="../views/usuarios/login.php">Acceso a Usuarios</a>
      </div>
